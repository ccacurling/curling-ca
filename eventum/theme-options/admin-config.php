            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'url'=> false,
                        'type' => 'media', 
                        'title' => __('Logo English', 'eventum'),
                        'default' => array( 'url' => get_template_directory_uri() .'/images/logo.png' ),
                        'subtitle' => __('Danielle: Make this a 300x100 pixel image!!!!! Upload your custom site logo.', 'eventum'),
                    ),
					array(
                        'id'=>'logoFR',
                        'url'=> false,
                        'type' => 'media', 
                        'title' => __('Logo French', 'eventum'),
                        'default' => array( 'url' => get_template_directory_uri() .'/images/logoFR.png' ),
                        'subtitle' => __('Danielle: THIS ONE TOO!!!! Upload your custom site logo.', 'eventum'),
                    ),
                    array(
                        'id'=>'footer-logo',
                        'url'=> false,
