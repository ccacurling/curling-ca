    ...
    function themeum_plugins_include()
    {
        $plugins = array(
                ...
                array(
                    ...
                    'external_url'          => 'https://downloads.wordpress.org/plugin/woocommerce.2.4.8.zip', // If set, overrides default API URL and points to an external URL
                ),                               
                array(
                    ...
                    'external_url'          => 'https://downloads.wordpress.org/plugin/mailchimp-for-wp.2.3.10.zip',
                ),                                 
                array(
