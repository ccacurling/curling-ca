...
if ( ! class_exists( 'RWMB_File_Field' ) )
{
	class RWMB_File_Field extends RWMB_Field
	{
		...
		{
			$i18n_title = apply_filters( 'rwmb_file_upload_string', esc_html__( 'Upload Files', 'file upload', 'meta-box' ), $field );
			$i18n_more  = apply_filters( 'rwmb_file_add_string', esc_html__( '+ Add new file', 'file upload', 'meta-box' ), $field );
		...
		{
			$i18n_delete = apply_filters( 'rwmb_file_delete_string', esc_html__( 'Delete', 'file upload', 'meta-box' ) );
			$i18n_edit   = apply_filters( 'rwmb_file_edit_string', esc_html__( 'Edit', 'file upload', 'meta-box' ) );
			$li          = '
			<li id="item_%s">
