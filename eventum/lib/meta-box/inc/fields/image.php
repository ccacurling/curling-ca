...
if ( ! class_exists( 'RWMB_Image_Field' ) )
{
	class RWMB_Image_Field extends RWMB_File_Field
	{
		...
		{
			$i18n_title = apply_filters( 'rwmb_image_upload_string', esc_html__( 'Upload Images', 'image upload', 'meta-box' ), $field );
			$i18n_more  = apply_filters( 'rwmb_image_add_string', esc_html__( '+ Add new image', 'image upload', 'meta-box' ), $field );
		...
		{
			$i18n_delete = apply_filters( 'rwmb_image_delete_string', esc_html__( 'Delete', 'image upload', 'meta-box' ) );
			$i18n_edit   = apply_filters( 'rwmb_image_edit_string', esc_html__( 'Edit', 'image upload', 'meta-box' ) );
			$li          = '
				<li id="item_%s">
					<img src="%s" />
