...
var thisPageSlug = "<?php echo $post->post_name; ?>";
var thisPageID = "<?php echo get_the_ID(); ?>";
</script>
<?php wp_head(); ?>
</head>
<?php global $is_IE ?>
...
<?php $logo_margin =''; if( tie_get_option( 'logo_margin' )) $logo_margin = ' style="margin-top:'.tie_get_option( 'logo_margin' ).'px"';  ?>
			<div class="search-block mobile_view">
					<form method="get" id="searchform" action="<?php echo home_url(); ?>/">
						<button class="search-button" type="button" value="<?php if( !$is_IE ) _e( 'Search' , 'tie' ) ?>"></button>	
						<input type="text" id="s" name="s" value="<?php _e( 'Search...' , 'tie' ) ?>" onfocus="if (this.value == '<?php _e( 'Search...' , 'tie' ) ?>') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php _e( 'Search...' , 'tie' ) ?>';}"  />
					</form>
				</div>
...
<?php 
   ...
   if( ICL_LANGUAGE_CODE == 'fr' ){ ?>
        <a title="<?php bloginfo('name'); ?>" href="http://www.curling.ca/nous-sommes-curling-canada/?lang=fr">
<?php    }else{ ?>
...
if ( is_page( 'scoreboard' ) ) {    
?>
    <div class="ads-top"><script src="//www.googletagservices.com/tag/js/gpt.js">googletag.pubads().definePassback('/4252397/CurlingScoreboardTopHeader', [728, 90]).display();</script>

<!--
<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<ins class="adsbygoogle"
     style="display:inline-block;width:728px;height:90px"
     data-ad-client="ca-pub-6276742856998243"
     data-ad-slot="1086221564"></ins>
<script>
