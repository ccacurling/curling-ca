...
<div class="content-wrap sigle_post-child">
	<div class="content">
		<?php tie_breadcrumbs() ?>
        ...
        <?php if( tie_get_option( 'post_date' ) && tie_get_option( 'time_format' ) != 'none' ): ?>		
				<?php __( 'on ' , 'tie' ); ?><div class="post_date"> <?php tie_get_time() ?></div>
		<?php endif; ?>
		...
		<?php if( tie_get_option( 'post_tags' ) ) the_tags( '<p class="post-tag">'.__( 'Tagged: ', 'tie' )  ,' ', '</p>'); ?>
