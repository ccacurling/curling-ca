...
<div class="block-event-info <?php echo $direction == 'left_to_right' ? 'block-event-info-row' : 'block-event-info-column'; ?> js-timer" data-date="<?php echo $start_date_unix; ?>">
  ...
  <div class="event-info-top-container">
    <?php
      if ($event_logo) {
    ?>
      <img class="event-info-top-image" src="<?php echo $event_logo['url']; ?>" alt="<?php echo __("Event Logo"); ?>" />
    <?php
      }
    ?>
  </div>
  ...
  <div class="block-event-info-details <?php echo $event_include_timer ? 'white' : 'gray'; ?>">
    <div class="block-event-info-detail-top-container">
      ...
      <?php
        if ($operated_by) {
      ?>
        <p class="block-event-sponsor-operated-by"><?php echo __("Operated by"); ?> <?php echo $operated_by; ?></p>
      <?php
        }
      ?>
      <?php
    ...
    <div class="event-info-bottom-container">
      <?php
        if ($buy_tickets_link) {
      ?>
        <a class="block-event-sponsor-tickets-btn btn btn-red" href="<?php echo $buy_tickets_link; ?>" target="blank"><?php echo $direction == 'left_to_right' ? __('Buy Tickets') : __('View Ticket Packages'); ?></a>
      <?php
        }
      ?>
      <div class="block-event-sponsor-links-container">
        <?php
          if ($event_page_link) {  
        ?>
          <a class="block-event-sponsor-link subdomain red arrow-right-item arrow-right-large-red" target="blank" href="<?php echo $event_page_link; ?>"><?php echo __("More Information"); ?></a>
          <?php
          }
        ?>
        <?php
        ...
        ?>
          <a class="block-event-sponsor-link subdomain red arrow-right-item arrow-right-large-red" target="blank" href="<?php echo $draw_schedule_link; ?>"><?php echo __("Event Schedule"); ?></a>
        <?php
          }
        ?>
        <?php
        ...
        ?>
          <a class="block-event-sponsor-link subdomain red arrow-right-item arrow-right-large-red" target="blank" href="<?php echo $meet_the_teams_link; ?>"><?php echo __("Meet the teams"); ?></a>
        <?php
          }
        ?>
      </div>
