...
<div class="footer footer-gray">
  <div class="footer-wrapper">
      ...
      <div class="footer-content-right-wrapper">
          <div>
          <a class="clear" href="https://mailchi.mp/curling.ca/collective" target="_blank"><h4 class="newsletter-signup-title inverted"><?php echo __("Sign up for the Newsletter"); ?></h4></a>
